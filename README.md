...
2. [SSAFY](#ssafysamsung-swai-academy-for-youth "SSAFY")
...
|학기|기간|내용|
|:-----|:-----|:-----|
|1학기|2025.07-2025.12|14기 서울캠퍼스 웹(자바) 트랙 1학기 수료|
|1학기|2025.11|11월 이달의 동료|
|2학기|2026.01-2026.02|2반 반장 (자치회)|
|2학기|2026.01-2026.02|공통 프로젝트 팀장 & 베스트 멤버|
|2학기|2026.02-2026.03|특화 프로젝트 & 발표회 진출 및 우수상 (2등)|
|2학기|2026.04-2026.05|자율 프로젝트 팀장 (창업 희망 트랙) & 베스트 멤버 & 공동 1등|
|2학기|2026.06|자율 프로젝트 전시발표회 - 전시|
|2학기|2025.07-2026.06|14기 서울캠퍼스 수료|

#### 프로젝트

> 반출 허락된 프로젝트의 경우 **프로젝트 이름**에 하이퍼링크가 포함됩니다.

|구분|프로젝트 이름|설명|역할|테크 스택|링크|
|:-----|:-----|:-----|:-----|:-----|:-----|
|1학기 관통|YumGovy|AI 기반 다이어트 코칭 웹 서비스|팀원(프론트엔드)|Vue.JS||
|2학기 공통|RoomInCode|실시간 턴제 코딩 배틀 게임 웹 서비스|팀장(프론트엔드)|Vue.JS||
...
|2학기 자율|🏆 GummyGom Delivery|화물을 목적지까지 옮겨야 하는 4인 협동 플랫포머 게임|팀장(시스템 및 콘텐츠 클라이언트, PM)|Unity 6, STEAMWORKS|[링크트리](https://linktr.ee/GummyGomDelivery "링크트리"), [STEAM STORE](https://store.steampowered.com/app/4607590/GummyGom_Delivery/ "Steam Store")|
